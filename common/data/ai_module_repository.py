...
class AiModuleRepository(BaseRepository):
    ...
    def add(self, name: str, description: str, enabled: bool, threshold: float, motion_detection_enabled: bool, persistence_enabled: bool,
    ...
    def check_sense_ai_default_modules(self):
        all_modules = self.get_all()
        default_modules = [
            ('od', 'Object Detection', True, 0.4, True, True, True),
            ('fd', 'Face Detection', True, 0.4, False, True, True),
            ('fr', 'Face Recognition', True, 0.4, False, True, True),
            ('alpr', 'Automatic License Plate Recognition', True, 0.4, False, True, True),
        ]
        for module in default_modules:
            if not any(x.name == module[0] for x in all_modules):
                self.add(module[0], module[1], module[2], module[3], module[4], module[5], module[6])
